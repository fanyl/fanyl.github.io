...
if(hash=='#close')
return _.closeFu()
_.li.each(function(n){if(_.hshx[n]==_.hash)/*51bbw.cn*/
...
_.markFu()
_.autoPlayFu()
if(_.useHash&&location.hash!=_.hshx[_.n])/*51bbw.cn*/
...
_.li=$('>li',_.ul)
_.preFu(_)
_.navs&&_.navs.navs(function(n){th.tabs(n)})}}/*51bbw.cn*/
if(typeof o=='object')
_=$.extend(true,_,o)
